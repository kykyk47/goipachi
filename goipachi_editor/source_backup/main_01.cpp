...
void display(void)
{
	...
	{
		UI_stage_info_0.SetImage(325, 148); //スロット固定
	}break;

	case 13: case 14: case 15:
	{
		UI_stage_info_1.SetImage(325, 148); //しりとり
	}break;

	case 23: case 24: case 25:
	{
		UI_stage_info_2.SetImage(325, 148); //スロット制限ＡＢＡＢ
	}break;
	}
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("goipachi editor ver.1.0.2");
