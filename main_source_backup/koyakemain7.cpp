...
int score_attack_mojisu = 4; //3or4or5 3文字，5文字はおいおい辞書を用意して実装したい．とりあえず4文字モードだけ
...
GameObject UI_mode_score_attack = GameObject(0, 0, 192, 192, L"./pic/mode_score_attack.png");
GameObject UI_mode_stage_clear = GameObject(0, 0, 192, 192, L"./pic/mode_stage_clear.png");
GameObject UI_mode_highlight = GameObject(0, 0, 192, 192, L"./pic/mode_highlight.png");
GameObject UI_mode_description_1 = GameObject(0, 0, 192, 192, L"./pic/mode_description_1.png");
GameObject UI_mode_description_2 = GameObject(0, 0, 192, 192, L"./pic/mode_description_2.png");
GameObject UI_mode_select_UI = GameObject(0, 0, 192, 192, L"./pic/mode_select_UI.png");
...
void display(void)
{
	...
	case 7: //モード選択画面
	{
		...
		UI_mode_score_attack.SetImage(0, -416);
		UI_mode_stage_clear.SetImage(0, -416);
		UI_mode_description_1.SetImage(0, 64);
		UI_mode_description_2.SetImage(0, 64);
		UI_mode_highlight.SetImage(0, 64);
		UI_mode_select_UI.SetImage(0, 64);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("goipachi ver.1.1-beta.0");
