...
GameObject UI_newrecord_stage = GameObject(0, 0, 96, 96, L"./pic/result_newrecord_stage.png");
...
GameObject UI_10_2 = GameObject(0, 0, 384, 192, L"./pic/menu_UI_10_2.png");
...
GameObject UI_time_limit_description = GameObject(0, 0, 1024, 128, L"./pic/time_limit_description.png");
...
void keyboard(unsigned char key, int x, int y)
{
	...
	case 7: //モード選択画面
	{
		...
		case 'k': {	if (mode == 0) { Mix_PlayChannel(-1, SE_enter, 0);  stage_select = 0;  scene = 8; } if (mode == 1) { Mix_PlayChannel(-1, SE_enter, 0);  stage_select = 1;  scene = 9; }} break; //スコアアタックモードはステージ０として扱う
	...
	case 8: //スコアアタックモード選択時の次の画面（文字数選択）
	{
		...
		case 'a': { if (mode_mojisu >=4) { mode_mojisu--; }} break; //文字数モード選択切り替え
